...
#   # require "#{Rails.root}/app/services/find_user_for_oauth.rb"
#   # TODO: Implement OmniAuthService to refactor OmniAuth-related logi
...
#       user = User.where(email: email).first if verified_email_from_oauth
#       # If user was not found, create one based on oauth data
#       user ||= find_or_create_new_user
#     end
...
#     # Query for user if verified email is provided
#     email = verified_email_from_oauth
