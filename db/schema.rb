...
ActiveRecord::Schema.define(version: 20150710142727) do
  ...
  create_table "moving_categories", force: :cascade do |t|
    t.string   "name"
    t.integer  "moving_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "moving_categories", ["moving_id"], name: "index_moving_categories_on_moving_id", using: :btree
  ...
  add_foreign_key "moving_categories", "movings"
